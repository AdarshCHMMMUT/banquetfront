...
//     if (path === "/addcategory") return "addcategory"; 
//     return "dashboard";
//   });
...
import Limits from "./pages/Category/limit"; // Import Limits component
import logo from "./assets/pcs.png"
const App = () => {
  const navigate = useNavigate();
  const location = useLocation();
  ...
  useEffect(() => {
    ...
    //   setActiveLink("updatecategory");
    // } else if (path === "/addcategory") {
    //   setActiveLink("addcategory");
    } else if (path === "/limits") {
      setActiveLink("limits");
    } else {
      setActiveLink("dashboard");
    }
  }, [location.pathname]);
              ...
              <ul className="mt-8 space-y-2 tracking-wide">
                ...
                >
                  ...
                  >
                    ...
                    <span className="-mr-1 font-medium">Add Category</span>
                  </a>
                </li> */}
                <li
                  onClick={() => {
                ...
                >
                  ...
                  >
                    ...
                    <span className="-mr-1 font-medium">Limits</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            ...
            <div className="px-6 pt-6 bg-white">
              <Routes>
                ...
                <Route path="/limits" element={<Limits />} /> {/* Add new route for Limits */}
              </Routes>
            </div>
          </div>
        </section>
